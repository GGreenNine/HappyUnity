...
namespace HappyUnity.Containters
{
    ...
    public sealed class Deque<T> : IList<T>, IReadOnlyList<T>, System.Collections.IList
    {
        ...
        public Deque(IEnumerable<T> collection)
        {
            ...
            var source = collection as IReadOnlyCollection<T>;
        ...
        {
            CheckNewIndexArgument(Count, index);
            var sourse = collection as IReadOnlyCollection<T>;
