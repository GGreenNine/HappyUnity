...
namespace HappyUnity.TransformUtils
{
    ...
    {
        [SerializeField] [HideInInspector] public UnityEvent beforeWrap;
        ...
        static Vector2 GetWorldPointFromViewport(Vector3 viewportPoint)
        {
